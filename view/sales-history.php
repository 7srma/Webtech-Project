...
<body>
    ...
    <center>
        <font color="#f55405" face="times new roman" size="12">Sales History</font><br><br>
        <hr color="#f55405" width="530px"><br>
            <?php
                ...
                <td>
                <font color=\"#f55405\" face=\"times new roman\" size=\"5\">Purchased Quantity</font>
                <hr color=\"#f55405\" width=\"75px\" align=\"left\">
                </td>
                <td>
                ...
                while ($row = mysqli_fetch_assoc($paymentInfo)) 
                {
                    ...
                    <tr>
                    <td>
                    <font color=\"black\" face=\"times new roman\" size=\"5\">$username </font>
                    </td>
                    <td>
                    ...
                    <td>
                    <font color=\"black\" face=\"times new roman\" size=\"5\">$purchasequantity</font>
                    </td>
                    <td>
                    <font color=\"black\" face=\"times new roman\" size=\"5\">$purchasedate</font>
                    </td>
                    </tr>";
                }
            }else{
                echo"<tr><td align=\"center\"><font color=\"black\" face=\"times new roman\" size=\"6\">No Sales History Found</font></td></tr>";
            }
        ?>
        </table>
        <br><br><br>
