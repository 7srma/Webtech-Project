...
<body>
    ...
    <center>
        <font color="#f55405" face="times new roman" size="12">Manage Product</font><br>
        ...
        <table width="60%" border="0" cellspacing="0" cellpadding="10">
            ...
            <tr align="center">
                <td>
                    <a href="ban-product.php"><font color="black" face="times new roman" size="6">Ban Product</font></a>
                </td>
            </tr>
            <tr align="center">
                <td>
                    <a href="approve-product.php"><font color="black" face="times new roman" size="6">Approve New Product</font></a>
                </td>
            </tr>
            <tr align="center">
                <td>
                    <a href="view-ban-product.php"><font color="black" face="times new roman" size="6">View Ban Product</font></a>
                </td>
            </tr>
        </table>
    </center>
