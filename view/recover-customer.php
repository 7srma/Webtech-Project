...
<body>
    ...
    <center>
        <font color="#f55405" face="times new roman" size="12">List Of Banned Customers</font><br><br><br>
        ...
        <?php 
            ...
            <tr>
                ...
                while($w=mysqli_fetch_assoc($result)){
                    ...
                    <td><a href=\"../controller/recover-controller.php?id={$userid}\"><font color=\"5799EF\" face=\"times new roman\" size=\"5\">Recover Customer</font></a></td>          
                    </tr>";
                }
            }else{
                echo"<tr><td align=\"center\"><font color=\"black\" face=\"times new roman\" size=\"6\">No Banned Customer Found</font></td></tr>";
            }
        ?>
        </table>
