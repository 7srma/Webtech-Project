...
<body>
    ...
    <center>
        <font color="#f55405" face="times new roman" size="12">Manage Payment</font><br><br><br>
        <hr color="#f55405" width="530px"><br><br><br>
        
        <table width="60%" border="0" cellspacing="0" cellpadding="10">
            <tr align="center">
                <td>
                    <a href="view-all-pending-order.php"><font color="black" face="times new roman" size="6">View All Pending Payment</font></a>
                </td>
            </tr>
            <tr align="center">
                <td>
                    <a href="approve-payment.php"><font color="black" face="times new roman" size="6">Approve Payment</font></a>
                </td>
            </tr>
        </table>
