...
<body>
    ...
    <center>
        <font color="#f55405" face="times new roman" size="12">List of Pending Payment</font><br><br><br>
        ...
        if(mysqli_num_rows($result)>0){
            ...
            <tr>
                ...
                while($w=mysqli_fetch_assoc($result)){
                    ...
                    <td><a href=\"../controller/approve-payment-controller.php?pid={$paymentid}\"><font color=\"5799EF\" face=\"times new roman\" size=\"5\">Approve Product</font></a></td>    
                    </tr>";
                }
            }else{
