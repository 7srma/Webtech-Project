...
<body>
    ...
    <center>
        <font color="#f55405" face="times new roman" size="12">List Ban Of Product</font><br><br><br>
        ...
        <?php 
                ...
                while($w=mysqli_fetch_assoc($result)){
                    ...
                    <td><a href=\"../controller/recover-product-controller.php?pid={$productid}\"><font color=\"5799EF\" face=\"times new roman\" size=\"5\">Recover Product</font></a></td>          
                        </tr>";
                    }
                }else{
                    echo"<tr><td align=\"center\"><font color=\"black\" face=\"times new roman\" size=\"6\">No Ban Product Found</font></td></tr>";
                }  
            ?>
        </table>
