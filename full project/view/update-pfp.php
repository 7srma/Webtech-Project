...
<body>
    ...
    <center>
    <form action="../controller/upload-controller.php" method="POST" enctype="multipart/form-data">
        <font color="#f55405" face="times new roman" size="12">Update Profile Picture</font><br><br><br>
        <hr color="#f55405" width="530px">
        <br><br><br><br><br>
        <table cellspacing="0" cellpadding="10" bgcolor="#f55405">
            <tr>
                <td>
