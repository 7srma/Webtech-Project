...
<body>
    ...
    <center>
        <font color="#f55405" face="times new roman" size="12">Product Info</font><br><br><br>
        ...
        <?php 
            ...
            <tr>
                ...
                while($w=mysqli_fetch_assoc($result)){
                    ...
                    <td><a href=\"product-page.php?pid={$pid}\"><font id=\"id\" color=\"5799EF\" face=\"times new roman\" size=\"5\">Show Details</font></a></td>          
                    </tr>";
                }
            }else{
