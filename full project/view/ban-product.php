...
<body>
    ...
    <center>
        <font color="#f55405" face="times new roman" size="12">List Of Product</font><br><br><br>
        ...
        <?php 
                ...
                while($w=mysqli_fetch_assoc($result)){
                    ...
                    <td><a href=\"../controller/ban-product-controller.php?pid={$productid}\"><font color=\"5799EF\" face=\"times new roman\" size=\"5\">Ban Product</font></a></td>          
                        </tr>";
                    }
                }else{
